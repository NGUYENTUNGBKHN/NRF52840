...
/*                                                                              */
/* DESCRIPTION                                                                  */
/*      Create data queue(ID number automatic assignment)                       */
/*                                                                              */
/* INPUT                                                                        */
...
TX_INTERRUPT_SAVE_AREA
    ...
    if((dtqid=_kernel_object_find(_kernel_dtq_id, _kernel_dtq_maxid))!=0)
    {
        if((rtn=(ER_ID)__cre_dtq(dtqid, pk_cdtq))==E_OK)
        {
            rtn = (ER_ID)dtqid;
        }
    }
