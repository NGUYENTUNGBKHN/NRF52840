...
/*                                                                              */
/*  Get memory from fixed sized memory pool by polling from non-task contexts   */
/*                                                                              */
/********************************************************************************/
...
/*                                                                              */
/* DESCRIPTION                                                                  */
/*      Get memory from fixed sized memory pool by polling from non-task        */
/*      contexts.                                                               */
/*                                                                              */
/* INPUT                                                                        */
...
ER ipget_mpf(ID mpfid, VP* p_blk)
{
    ...
    return __tget_mpf(mpfid, p_blk, TMO_POL);
}
