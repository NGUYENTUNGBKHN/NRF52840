...
/*      pk_rflg             Pointer to the packet returning the event flag      */
/*                          state.                                              */
/*                                                                              */
/* OUTPUT                                                                       */
...
TX_INTERRUPT_SAVE_AREA
    ...
    if(pFlg!=NULL)
    {
        if(pFlg->wtsk!=NULL)
        {
            pk_rflg->wtskid = ((_KERNEL_UITRON_TSK*)pFlg->wtsk->data)->tskid;
        }
        else
        {
